...
var hangman = {
    ...
    init: function() {
        ...
        // document.querySelector("#hangman-img").src = 'assets/images/hp.jpg';
    },
    ...
    winLoseCountAndAudioOnGameEnd: function() {
        if (this.lives === 0) {
            document.querySelector("#hangman-img").src = "assets/images/hp.";
    ...
    startNewOnGameOver: function() {
        if (this.gameOver === true) {
            ...
            html += '<div class="load">Next word will appear in 4 seconds... ';
